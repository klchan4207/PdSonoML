# based on GNN_formula_reg10.py
# "##" refers to ignoring old code line
...
class MODEL(tf.keras.Model):
    ...
    def call(self,  input_data,
        ...
        # treat rct
        rct_inputs = tf.convert_to_tensor(rct_inputs_data,dtype=tf.float32)
        ...
        # treat lig
        lig_inputs = tf.convert_to_tensor(lig_inputs_data,dtype=tf.float32)
